...
from deepmap.deepforest import dataset, visualize, get_data, utilities, predict
from deepmap.deepforest import evaluate as evaluate_iou
...
class deepforest(pl.LightningModule):
    ...
    def create_model(self):
        ...
        if self.model is None:
            model_name = importlib.import_module("deepmap.deepforest.models.{}".format(
